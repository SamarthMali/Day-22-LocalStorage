...
function getData(){
    ...
    let htmlString =
        ...
        toDoData.forEach(ele =>{
            ...
            <td>
            <button onclick="edit(${counter})" class=" btn btn-warning text-white">Edit</button>
            <button onclick="deleteToDo(${counter})" class="  btn btn-danger">Delete</button>
            <button onclick="complete(${counter})" class="  btn btn-success">Complete</button>
